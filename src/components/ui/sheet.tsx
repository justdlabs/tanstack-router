...
const contentStyles = tv({
	...
	variants: {
		...
		side: {
			...
			bottom: "inset-x-0 bottom-0 rounded-t-2xl border-t data-entering:slide-in-from-bottom data-exiting:slide-out-to-bottom",
			...
			right: "inset-y-0 right-0 h-auto w-[18rem] sm:w-[19rem] sm:w-3/4 overflow-y-auto border-l data-entering:slide-in-from-right data-exiting:slide-out-to-right sm:max-w-xs",
		},
		isFloat: {
